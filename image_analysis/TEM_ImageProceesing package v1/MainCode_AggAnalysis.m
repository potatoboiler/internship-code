...
%%%% Dastanpour & Rogak (2014) DOI:10.1080/02786826.2014.955565
%%%% and https://circle.ubc.ca/bitstream/id/14450/ubc_2008_fall_soewono_arka.pdf
...
for k = 1:num_img % run loop as many times as images selected
    ...
    elseif strcmp(choise,'Others -> Manual detection of magnification size') % manually determine magnification
        ...
        mag_crop = imcrop(Processing_im); % crop image
        close (gcf);
        clear choise
...
%     for l = 1:n_aggregate
        ...
        if exist('Output','dir') ~= 7 %checking whether the Output folder is available 
